...
public class TrajectorySegmentPartialWithIntervalMetadataReadSupport extends ReadSupport<TrajectorySegmentWithIntervalMetadata> {
...
//                "required INT64 maxTimestamp;\n" +
    ...
    public RecordMaterializer<TrajectorySegmentWithIntervalMetadata> prepareForRead(Configuration configuration, Map<String, String> map, MessageType messageType, ReadContext readContext) {
        return new TrajectorySegmentPartialWithIntervalMetadataMaterializer();
    }
}
