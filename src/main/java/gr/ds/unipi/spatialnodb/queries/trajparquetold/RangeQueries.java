...
public class RangeQueries {
    public static void main(String args[]) throws IOException {
        ...
        sparkConf.setAppName("Range Querying in TrajParquet Old Version");
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter(metricsPath+ File.separator+"range-queries-trajparquetold-"+ Paths.get(queriesFilePath).getFileName().toString().replaceFirst("\\.[^.]+$", "")+"-"+Paths.get(parquetPath).getFileName().toString()+".txt"));
...
//            });
        ...
        bw = new BufferedWriter(new FileWriter(metricsPath+ File.separator+"metrics-range-queries-trajparquetold-"+ Paths.get(queriesFilePath).getFileName().toString().replaceFirst("\\.[^.]+$", "")+"-"+Paths.get(parquetPath).getFileName().toString()+".txt"));
