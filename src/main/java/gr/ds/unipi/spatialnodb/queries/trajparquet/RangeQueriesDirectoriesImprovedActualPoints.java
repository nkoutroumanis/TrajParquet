...
public class RangeQueriesDirectoriesImprovedActualPoints {
    public static void main(String args[]) throws IOException {
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter(metricsPath+ File.separator+"range-queries-trajparquetDirectoriesImprovedActualPoints-"+ Paths.get(queriesFilePath).getFileName().toString().replaceFirst("\\.[^.]+$", "")+"-"+Paths.get(parquetPath).getFileName().toString()+".txt"));
...
//                System.out.println(voidTrajectoryTuple2._2.getObjectId()+" "+voidTrajectoryTuple2._2.getSpatioTemporalPoints().length+" "+Arrays.toString(voidTrajectoryTuple2._2.getSpatioTemporalPoints()));
        ...
        bw = new BufferedWriter(new FileWriter(metricsPath+ File.separator+"metrics-range-queries-trajparquetDirectoriesImprovedActualPoints-"+ Paths.get(queriesFilePath).getFileName().toString().replaceFirst("\\.[^.]+$", "")+"-"+Paths.get(parquetPath).getFileName().toString()+".txt"));
